      ...
      <div class="flex flex-col">
        ...
        <div class="bg-blue-50 min-h-screen">
          ...
          <div class=" mt-5 grid  lg:grid-cols-3  md:grid-cols-3 p-4 gap-3">
            ...
            <div class="col-span-2 flex flex-col p-8 bg-white rounded shadow-sm h-96">
              <b class="flex flex-row text-gray-500">New Post</b>
            ...
            <div class="bg-white ">
              <div class="container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py-6 ">
                <div class="text-center divide-y sm:divide-y-0 sm:divide-x ">
                  <div class="flex items-center justify-center">
                    <div class="flex mx-5 mt-4 text-white">
                      <a href="/dashboard/posts/create" class="group">
                        <div class="border bg-gradient-to-b from-blue-500 to-blue-600 shadow-blue-600/50 group-hover:bg-gradient-to-b group-hover:from-blue-700 group-hover:to-blue-800 p-2 flex rounded-lg">
                          ...
                          <p class="px-2 text-2xl">Create Post</p> 
                        </div>
                      </a>
                    </div>
                  </div>
                  ...
                  <div class="space-y-1 p-5">
                    ...
                    <div class="text-sm uppercase tracking-wide font-semibold text-blue-600">
                      total Post
                    </div>
                  </div>
                </a>
