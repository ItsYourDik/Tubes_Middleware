        ...
        <div class="shadow sm:overflow-hidden sm:rounded-md">
          <div class="space-y-6 bg-white px-4 py-5 sm:p-6">
            ...
            <div class="col-span-6 ">
              ...
              <input type="text" name="slug" id="slug"  class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required value="{{ old('title', $post->slug) }}">
            </div>
            ...
            <div>
              ...
              @if ($post->image)
              <img src="{{ asset('storage/' . $post->image) }}" class="img-previeww-3/12 my-2">
            @else
              <img class="img-preview w-3/12 my-2">
            @endif
