...
@section('container')
    <section>
        <div class="min-h-screen flex flex-col justify-center items-center bg-fixed bg-cover" style="background-image: url(img/jumbotron.jpg)">
        ...
        <div class="h-screen static">
            <div class="grid grid-cols-2">
                ...
                <div class="ml-10 self-center font-Montserrat">
                    ...
                    <p class="pt-2">Explore Pangalengan</p>
